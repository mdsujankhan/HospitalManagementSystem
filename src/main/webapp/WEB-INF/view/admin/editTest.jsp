			...
			<div class="col-sm-10 col-md-8 col-lg-8 mx-auto d-table h-100">
				<div class="d-table-cell align-middle"
					...
					<div class="text-center mt-4">
						...
						<p class="lead">Fill the following fields to add a Test.</p>
					</div>

					<div class="card">
						<div class="card-body">
							<div class="m-sm-4">
								<form action="/admin/updateTest" method="POST">
									<input type="hidden" name="id" value="${u.id}">
									
									<div class="mb-3">
										<label class="form-label">Code </label> <input
									...
									<div class="mb-3">
										<label class="form-label">Department </label> <select
											...
											<option value="Diagnostic  Imaging">Diagnostic
												Imaging</option>
									...
									<div class="mb-3">
										<label class="form-label">Fee</label> <input
											class="form-control form-control-lg" type="text" name="fee"
											value="${u.fee}" />
									</div>
