...
<!-- Theme style -->
<link rel="stylesheet" href="/app-assets/tabledist/css/adminlte.min.css">
</head>
			...
			<div class="sidebar-content js-simplebar">
				...
				<ul class="sidebar-nav">
					...
					<li class="sidebar-item"><a class="sidebar-link" href="home">
							...
							class="align-middle">Receptionist's Dashboard</span>
					</a></li>

					<li class="sidebar-item"><a class="sidebar-link"
						href="/patient/add"> <i class="align-middle"
							data-feather="user"></i> <span class="align-middle">Add
								Patient</span>
					</a></li>

					<li class="sidebar-item"><a class="sidebar-link"
						href="/receptionist/contactInput"> <i class="align-middle"
							data-feather="file-plus"></i> <span class="align-middle">Create
								Invoice</span>
					</a></li>

					<li class="sidebar-item"><a class="sidebar-link"
						href="/receptionist/home"> <i class="align-middle"
							data-feather="clipboard"></i> <span class="align-middle">Applications</span>
					</a></li>


					<li class="sidebar-item"><a class="sidebar-link"
						href="/appointment"> <i class="align-middle"
							data-feather="clipboard"></i> <span class="align-middle">Book
								Appointment</span>
					</a></li>

					<li class="sidebar-header">Receptionist Others Functionality</li>

					<li class="sidebar-item active"><a class="sidebar-link"
						href="ui-forms.html"> <i class="align-middle"
							data-feather="check-square"></i> <span class="align-middle">Appointment's</span>
					</a></li>

					<li class="sidebar-item"><a class="sidebar-link"
						href="#"> <i class="align-middle"
							data-feather="grid"></i> <span class="align-middle">Covid Tests</span>
					</a></li>
					...
					<ul class="navbar-nav navbar-align">
									...
									<a href="#" class="list-group-item">
										<div class="row g-0 align-items-center">
											...
											<div class="col-10 ps-2">
												<div class="text-dark">Imran Hossain</div>
												<div class="text-muted small mt-1">Hello, Brother how are you?.</div>
												<div class="text-muted small mt-1">25m ago</div>
											</div>
										</div>
									</a>
								</div>
						...
						<li class="nav-item dropdown"><a
							...
							href="#" data-bs-toggle="dropdown"> <img
								...
								class="avatar img-fluid rounded me-1" alt="Receptionist" /> <span
								class="text-dark">Receptionist</span>
						</a>
