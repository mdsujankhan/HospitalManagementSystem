			...
			<div class="sidebar-content js-simplebar">
				...
				<ul class="sidebar-nav">
					...
					<li class="sidebar-item"><a class="sidebar-link" href="home">
							...
							class="align-middle">Doctor's Dashboard</span>
					</a></li>

					<li class="sidebar-item"><a class="sidebar-link"
						href="/doctor/appointments"> <i class="align-middle"
							data-feather="clipboard"></i> <span class="align-middle">Confirmed
								Appointments</span>
					</a></li>

					<li class="sidebar-item"><a class="sidebar-link" href="/doctor/addPatient">
					...
					<li class="sidebar-item"><a class="sidebar-link" href="#">
							...
							class="align-middle">Applications</span>
					</a></li>


					<li class="sidebar-item"><a class="sidebar-link"
						href="#"> <i class="align-middle"
							data-feather="align-left"></i> <span class="align-middle">View Prescription</span>
					</a></li>

					<li class="sidebar-item"><a class="sidebar-link"
						href="#"> <i class="align-middle"
							data-feather="coffee"></i> <span class="align-middle">Create Prescription</span>
					</a></li>
				</ul>
			</div>
		</nav>
					...
					<ul class="navbar-nav navbar-align">
									...
									<a href="#" class="list-group-item">
										<div class="row g-0 align-items-center">
											...
											<div class="col-10 ps-2">
												<div class="text-dark">Md. Mamun Hossain</div>
												<div class="text-muted small mt-1">Are You free?</div>
												<div class="text-muted small mt-1">50m ago</div>
											</div>
										</div>
									</a>
								</div>
						...
						<li class="nav-item dropdown"><a
							...
							href="#" data-bs-toggle="dropdown"> <img
								...
								class="avatar img-fluid rounded me-1" alt="doctor" /> <span
								class="text-dark">Doctor</span>
						</a>
